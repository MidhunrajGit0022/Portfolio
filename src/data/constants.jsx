...
},
{
...
},
 {
    ...
    // date: "2024",
    description:
      "ViknBooks POS is a Flutter-based Point of Sale application developed to streamline billing, inventory tracking, sales management, and payment processing. The system includes real-time data handling, offline storage support, API integration, and responsive UI for efficient retail business operations.",
    image:
      "../assets/viknbookspos.png",
    tags: [
      "Flutter",
      "GetX",
      "REST API",
