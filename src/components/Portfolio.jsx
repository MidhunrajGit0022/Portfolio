        ...
        <>
            <div className="bgimg">
                ...
                {/* <Navbar expand="lg" bg="navbarbg fixed-top" className={scrolled ? 'd-none' : ''}> */}
                    <Container>
                        <Navbar.Brand className='d-flex '>Mx.Dev</Navbar.Brand>
                        <Navbar.Toggle
                        ...
                        <Navbar.Collapse id="basic-navbar-nav">
                            <Nav className="mx-auto p-2">
                                <Nav.Link className='ms-2 ' onClick={handleNavLinkClick}><div className="navlink">Home</div></Nav.Link>
                                <Nav.Link className='ms-2 ' onClick={handleNavLinkClick}><div className="navlink">About</div></Nav.Link>
                                <Nav.Link className='ms-2 ' onClick={handleNavLinkClick}><div className="navlink">Projects</div></Nav.Link>
                                <Nav.Link className='ms-2 ' onClick={handleNavLinkClick}><div className="navlink">Contact</div></Nav.Link>
                                <Nav.Link className='ms-2 ' onClick={() => { settheme(!theme) }}>  {theme
                                    ?
